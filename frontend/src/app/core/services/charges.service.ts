...
export interface Charge {
  ...
  amount: number;
  breakdown: { withoutLightFee: number; lightFee: number; ballBoyFee: number; guestFee?: number; rentalFee?: number; convenienceFee?: number; convenienceFeeMode?: string; extraFees?: { name: string; amount: number }[]; extraFeeTotal?: number; coachingFee?: number; gameFee?: number; hostedPlayFee?: number; supportAmount?: number };
