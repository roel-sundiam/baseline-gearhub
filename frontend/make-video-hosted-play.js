...
const SLIDES = [
  ...
  },
  {
    ...
    tag: 'Session Setup', title: 'Create a session\nin under a minute',
    desc: 'Set the title, sport, date, fee, max players, and number of courts. Queue management is one toggle.',
    bullets: ['Sport, date, time, and venue', 'Fee per player — free or paid', 'Max players & court count', 'Queue management ON in one toggle'],
    img: 'http://localhost:4200/features/hp-create-form.png',
    narration: 'Admins create a session in under a minute. Set the date, fee, courts, and flip the queue management toggle on.',
  },
  {
    type: 'feature', reverse: false, duration: 6500,
